...
const Coinsdetail = () => {
  ...
  if (error) return <Error message={"error while fetching the api"} />;
      ...
      {loading ? (
        ...
        <>
          <Box w={"full"} borderWidth={1}>
            <Chart arr={chartarray} currency={currencySym  } days={days} />
          </Box>
          ...
          <VStack spacing={"4"} padding={"16"} alignItems={"flex-start"}>
            ...
            <Box w={"full"} p={"4"}>
              ...
              <Item title={"Market Cap"} value={`${currencySym}${coin.market_data.market_cap[currency]}`}/>
              <Item title={"All time low"} value={`${currencySym}${coin.market_data.atl[currency]}`}/>
              <Item title={"All time high"} value={`${currencySym}${coin.market_data.ath[currency]}`}/>
